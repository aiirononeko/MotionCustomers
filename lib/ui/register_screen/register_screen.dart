          ...
          SizedBox(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: EdgeInsets.only(right: width * 0.08, bottom: height * 0.03),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Checkbox(
                          value: context.select((RegisterViewModel value) => value.flag),
                          onChanged: context.read<RegisterViewModel>().handleCheckbox,
                  ...
                  ElevatedButton(
                    ...
                    onPressed: !context.select((RegisterViewModel value) => value.flag)? null: () async {
                      // 入力値のチェック
